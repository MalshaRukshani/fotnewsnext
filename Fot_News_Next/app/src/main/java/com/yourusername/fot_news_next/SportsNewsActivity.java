package com.yourusername.fot_news_next;
...
import com.yourusername.fot_news_next.model.News;
import com.yourusername.techpulse_newsapp.R;
...
public class SportsNewsActivity extends BaseActivity {
    ...
    private List<com.yourusername.fot_news_next.model.News> sportsList;
    ...
    private void createNewsCard(News news) {
        ...
        readButton.setBackgroundTintList(ColorStateList.valueOf(Color.parseColor("#00FFCC")));
